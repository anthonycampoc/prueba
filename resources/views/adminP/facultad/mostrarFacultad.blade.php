                            ...
                            @foreach ($facultadA as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a title="ESTADO"  class="mdl-button mdl-button--icon mdl-js-button mdl-js-ripple-effect" href="{{route('facultad.estado', $item->id)}}">
                                    ...
                                    <a title="EDITAR"  class="mdl-button mdl-button--icon mdl-js-button mdl-js-ripple-effect" href="{{route('facultad.edit', $item->id)}}">
