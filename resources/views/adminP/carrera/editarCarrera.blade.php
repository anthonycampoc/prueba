                ...
                <div class="mdl-cell mdl-cell--4-col-phone mdl-cell--8-col-tablet mdl-cell--8-col-desktop mdl-cell--2-offset-desktop">
                    <div class="full-width panel mdl-shadow--2dp">
                        ...
                        <div class="full-width panel-content">
                            <form action="{{route('carrera.update', $carrera->id)}}" method="POST"  enctype="multipart/form-data">
                                @csrf
                                @method("PUT")
                                <h5 class="text-condensedLight">Datos Carrera</h5>

                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                    <input value="{{$carrera->nombre}}" name="nombre" class="mdl-textfield__input" type="text" id="NameClient">
                                ...
                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                    <input value="{{$carrera->cantEstudiante}}" name="cantEstudiante" class="mdl-textfield__input" type="text" id="NameClient">
                                ...
                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                    <input value="{{$carrera->duracion}}" name="duracion" class="mdl-textfield__input" type="text" id="NameClient">
                                    ...
                                    <select name="facultad_id" class="mdl-textfield__input">
                                        ...
                                        @foreach ($facultad as $item)
                                                <option value="{{$item->id}}"
                                                    @if ($item->id == $carrera->facultad->id)
                                                        selected
                                                    @endif
                                                    >
