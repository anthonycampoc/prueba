                        ...
                        <div class="full-width panel-content">
                            <form action="{{route('empresa.update', $empresa->id)}}" method="POST">
                               ...
                               <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                    <input value="{{$empresa->nombre}}" name="nombre" class="mdl-textfield__input" type="text" id="NameClient">
                                ...
                                <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                    <input value="{{$empresa->ruc}}" name="ruc" class="mdl-textfield__input" type="text" id="NameClient">
